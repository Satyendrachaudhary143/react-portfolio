...
function Cart({ title, description, img, github, demo, technologies }) {
    return (
            ...
            <div className="p-4 sm:p-6 flex-grow flex flex-col">
                ...
                <div className="flex gap-3 sm:gap-4 mt-auto">
                    <motion.a 
                        ...
                        whileTap={{ scale: 0.95 }}
                        className="flex-1 bg-[#1a1a2e] text-white px-3 sm:px-4 py-2 rounded-lg font-semibold hover:bg-[#e94560] transition-colors duration-300 text-center flex items-center justify-center gap-1.5 sm:gap-2 border border-gray-800 hover:border-[#e94560] text-sm sm:text-base"
                    >
                    ...
                    <motion.a 
                        ...
                        whileHover={{ scale: 1.05 }}
                        whileTap={{ scale: 0.95 }}
                        className="flex-1 bg-[#e94560] text-white px-3 sm:px-4 py-2 rounded-lg font-semibold hover:bg-[#d13d56] transition-colors duration-300 text-center flex items-center justify-center gap-1.5 sm:gap-2 text-sm sm:text-base"
                    >
